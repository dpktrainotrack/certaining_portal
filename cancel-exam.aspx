<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="cancel-exam.aspx.cs" Inherits="Center.cancel_exam" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <nav class="te-breadcrumb" aria-label="breadcrumb">
                            <ol>
                                ...
                                <li class="te-breadcrumb__active">Cancel Exam</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="te-card">
                            <div class="te-card__header te-card__header--accent">
                                ...
                                <span>Cancelled Exam Records</span>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:LinkButton ID="LinkButton1" CssClass="btn te-btn-view"
                                                                runat="server"
                                                                Visible='<%# Eval("Examstatus").ToString() != "Cancelled Exam" %>'
                                                                Text="Cancel Exam" CommandName="Cancel"
                                                                OnClientClick="return confirm(' Are you sure, you want to cancel this exam?');">

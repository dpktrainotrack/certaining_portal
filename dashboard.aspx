    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <style>
            ...
            .dash-stat-card {
                ...
                position: relative;
                overflow: hidden;
                border-bottom: 5px solid #007388;
            }
                ...
                <div class="row mt-4">
                    <div class="col-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server"
                                                                ...
                                                                CssClass=" es-status"
                                                                style='<%# "background-color: " + (Eval("Examstatus").Equals("Waiting to get hold of") ? "hotpink" : (Eval("Examstatus").Equals("Cancelled Exam") ? "darkorange" : "#28a745")) + "; color: white;" %>'>
                                                            </asp:Label>
                                                        </td>
                                                        <td class="text-center">
                                                            <a class="te-btn-view text-decoration-none d-inline-block"
                                                                href='today-exam-details?RegistationId=<%#EncryptString(Eval("aadhar_card").ToString()) %>&ExamDate=<%#EncryptString(Eval("exam_date").ToString()) %>'
                                                                style="line-height: 1.5;">View</a>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                                ...
                                                <td colspan="7" style="padding: 0;">
                                                    <div id="dvNoRecords" runat="server" visible="false">
                                                        <div class="text-center p-4">
                                                            <h5 class="te-error-msg m-0"><i
                                                                    class="fa fa-exclamation-circle me-2"></i> No
                        ...
                        <div class="d-flex justify-content-center mt-4 mb-4">
                            <a id="btnMoreRecord" runat="server" class="te-btn-primary text-decoration-none"
                                href="all-candidate-records"
                                style="min-width: 200px; padding: 12px 30px; border-radius: 30px; font-weight: 600; box-shadow: 0 4px 15px rgba(0, 115, 136, 0.2);">

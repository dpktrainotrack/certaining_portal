                            ...
                            <div class="te-card__body">
                                <div class="row form-row mb-3 gy-4">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <asp:TextBox ID="txt_first_name1" runat="server" Placeholder="First Name"
                                            class="form-control te-input" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="te-label">Last Name</label>
                                        <asp:TextBox ID="txt_last_name1" runat="server" Placeholder="Last Name"
                                            class="form-control te-input" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="te-label">Email Id*</label>
                                        <asp:TextBox ID="txt_search" runat="server" Placeholder="Email"
                                            class="form-control te-input" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="te-label">Phone Number*</label>
                                        <asp:TextBox ID="txt_phone_number1" runat="server" Placeholder="Mobile Number"
                                            class="form-control te-input" />
                                    </div>
                                </div>
                                ...
                                <div class="row form-row mb-4">
                                    ...
                                    <div class="d-inline">
                                        <asp:Button ID="btn_search" runat="server" Text="Search" class="te-btn-primary"
                                            OnClick="Locate_Record" ValidationGroup="Search"
                                            style="min-width: 200px; padding: 10px 30px; border: none; font-size: 16px; border-radius: 30px;" />
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:Label runat="server" ID="Label2"
                                                                Text='<%#Eval("middle_name") %>'></asp:Label>
                                                            <asp:Label runat="server" ID="Label3"
                                                                Text='<%#Eval("last_name") %>'></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label runat="server" ID="Label4"
                                                                Text='<%#Eval("email_address") %>'></asp:Label>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            <asp:LinkButton ID="LinkButton1"
                                                                class="te-btn-view d-inline-block text-decoration-none"
                                                                runat="server" Text="Exam Detail" CommandName="Edit"
                                                                style="line-height: 1.5;"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
